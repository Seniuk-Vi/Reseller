...
public class FragmentForOrdersOne extends Fragment {

    public static FragmentForOrdersOne newInstance() {
        return new FragmentForOrdersOne();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.activity_fragment_for_orders_one, container, false);
        ...
        String order = mFirebaseUser1 + "Orders";
        mDatabaseRef1 = FirebaseDatabase.getInstance().getReference(order);
    ...
    private ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            try {
                ...
                Collections.reverse(mUploads2);
                mAdapter1 = new UserRecyclerViewAdapter(getActivity(), mUploads2);
                mProgressCircle1.setVisibility(View.INVISIBLE);
                mRecyclerView1.setAdapter(mAdapter1);
                ((UserRecyclerViewAdapter) mRecyclerView1.getAdapter()).notifyDataSetChanged();
